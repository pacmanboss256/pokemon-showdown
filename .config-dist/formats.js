 ...
 const Formats = [
	...
	},
	{
		...
		onValidateTeam(team) {
			...
			for (const set of team) {
				const item = this.dex.getItem(set.item);
				if (!_optionalChain([item, 'optionalAccess', _4 => _4.megaStone])) continue;
				const species = this.dex.getSpecies(set.species);
	...
	},
	{
		...
		checkCanLearn(move, species, lsetData, set) {
			// @ts-ignore
			if (!_optionalChain([set, 'access', _5 => _5.sp, 'optionalAccess', _6 => _6.exists]) || !_optionalChain([set, 'access', _7 => _7.crossSpecies, 'optionalAccess', _8 => _8.exists])) {
