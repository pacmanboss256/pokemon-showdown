	...
	startFinals(timeout) {
		...
		setTimeout(() => {
			...
			if (second && third) {
				...
				const thirdPlace = _lib.Utils.escapeHTML(second.name);
...
const triviaCommands = {
	...
	migrate(target, room, user) {
		...
		exports.triviaData.questions[destinationCategory] = exports.triviaData.questions[destinationCategory]
			.concat(exports.triviaData.questions[sourceCategory]);
