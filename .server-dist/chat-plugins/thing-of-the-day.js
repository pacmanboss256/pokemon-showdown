...
const prenoms = JSON.parse(_lib.FS.call(void 0, PRENOMS_FILE).readIfExistsSync() || "{}");
...
function savePrenoms() {
	return _lib.FS.call(void 0, PRENOMS_FILE).write(JSON.stringify(prenoms));
}
...
class OtdHandler {
	...
	constructor(
		...
		this.file = _lib.FS.call(void 0, filename);
