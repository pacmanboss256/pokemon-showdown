...
const Hazards = [
 ...
 class RandomTeams {
	...
	allowExtraRejectionInSingles(move) {
	...
	allowExtraRejectionInDoubles(move) {
	...
	randomSet(
		...
		do {
			...
			const runRejectionChecker = (checkerName) => (
				_optionalChain([this, 'access', _7 => _7.moveRejectionCheckers, 'access', _8 => _8[checkerName], 'optionalCall', _9 => _9(
		...
		const level = (isDoubles ? species.randomDoubleBattleLevel : species.randomBattleLevel) || 80;
