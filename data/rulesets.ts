...
export const Formats: {[k: string]: FormatData} = {
	...
	rrc: {
		...
		ruleset: ['Obtainable', '+Unobtainable', '+Past', 'Team Preview', 'Species Clause', 'Nickname Clause', 'HP Percentage Mod', 'Cancel Mod', 'Endless Battle Clause', 'Item Clause', 'Dynamax Clause'],
		banlist: [
