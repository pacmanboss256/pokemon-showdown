...
export const Formats: FormatList = [
	...
	},
	{
		...
		mod: 'gen8',
		ruleset: ['Standard NatDex', 'OHKO Clause', 'Evasion Moves Clause', 'Species Clause', 'Sleep Clause Mod', 'Moody Clause', 'Dynamax Clause', 'CFZ Clause', 'Z-Move Clause'],
		banlist: [
			// ubers
			...
			// abilities
			'Power Construct', 'Shadow Tag', 'Arena Trap',
			// moves
