...
export declare class BattleQueue {
    ...
    shift(): MoveAction | SwitchAction | TeamAction | FieldAction | PokemonAction | undefined;
    ...
    willAct(): MoveAction | SwitchAction | TeamAction | FieldAction | PokemonAction | null;
     ...
     */
    static comparePriority(a: AnyObject, b: AnyObject): number;
}
