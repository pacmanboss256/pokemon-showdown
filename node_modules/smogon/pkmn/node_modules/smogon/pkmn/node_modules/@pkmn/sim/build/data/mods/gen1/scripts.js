...
exports.Scripts = {
    ...
    tryMoveHit(target, pokemon, move) {
        ...
        if (move.volatileStatus === 'partiallytrapped' && target === ((_a = pokemon.volatiles['partialtrappinglock']) === null || _a === void 0 ? void 0 : _a.locked)) {
            accuracy = true;
        }
    ...
    moveHit(target, pokemon, move, moveData, isSecondary, isSelf) {
            ...
            if (moveData.status) {
                ...
                if (moveData.status === 'slp' && target.volatiles['mustrecharge']) {
                    ...
                    if (target.setStatus(moveData.status, pokemon, move)) {
                        ...
                        this.hint("In Gen 1, if a Pokémon that has just used Hyper Beam and has yet to recharge is targeted with a sleep inducing move, " +
        ...
        const targetHasSub = !!(target === null || target === void 0 ? void 0 : target.volatiles['substitute']);
    ...
    boost(boost, target, source = null, effect = null) {
        ...
        if (typeof effect === 'string')
            effect = this.dex.getEffect(effect);
        if (!target || !target.hp)
            return 0;
        let success = null;
