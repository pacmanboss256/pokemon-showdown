...
exports.Scripts = {
    ...
    moveHit(target, pokemon, move, moveData, isSecondary, isSelf) {
        ...
        if ((target === null || target === void 0 ? void 0 : target.hp) && moveData.secondaries && this.runEvent('TrySecondaryHit', target, pokemon, moveData)) {
    ...
    getDamage(pokemon, target, move, suppressMessages) {
        ...
        else if ((this.field.isWeather('raindance') && (type === 'Fire' || move.id === 'solarbeam')) ||
