import { AnyObject, EffectData, EffectType, EventInfo, ID, MoveSource, NatureData, Nonstandard, SparseStatsTable, StatNameExceptHP, TypeData } from './exported-global-types';
/**
...
export declare function combine(obj: AnyObject, ...data: (AnyObject | null)[]): AnyObject;
export {};
