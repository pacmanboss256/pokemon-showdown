...
declare type StatNameExceptHP = 'atk' | 'def' | 'spa' | 'spd' | 'spe';
declare type StatName = 'hp' | StatNameExceptHP;
declare type StatsExceptHPTable = {
    [stat in StatNameExceptHP]: number;
};
declare type StatsTable = {
    [stat in StatName]: number;
};
declare type SparseStatsTable = Partial<StatsTable>;
declare type BoostName = StatNameExceptHP | 'accuracy' | 'evasion';
declare type BoostsTable = {
    [boost in BoostName]: number;
};
...
declare namespace TierTypes {
    type Singles = "AG" | "Uber" | "(Uber)" | "OU" | "(OU)" | "UUBL" | "UU" | "RUBL" | "RU" | "NUBL" | "NU" | "(NU)" | "PUBL" | "PU" | "(PU)" | "NFE" | "LC Uber" | "LC";
    type Doubles = "DUber" | "(DUber)" | "DOU" | "(DOU)" | "DBL" | "DUU" | "(DUU)" | "NFE" | "LC Uber" | "LC";
...
declare type ModdedLearnsetData = LearnsetData & {
    inherit?: true;
};
...
declare type GameType = 'singles' | 'doubles' | 'triples' | 'rotation' | 'multi' | 'free-for-all';
