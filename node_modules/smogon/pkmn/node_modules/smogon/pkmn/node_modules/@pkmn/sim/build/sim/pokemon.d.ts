import { Ability, ActiveMove, AnyObject, Battle, BoostsTable, Condition, DynamaxOptions, Effect, GenderName, ID, Item, Move, PokemonSet, Side, SideID, SparseBoostsTable, Species, StatNameExceptHP, StatsExceptHPTable, StatsTable } from './exported-global-types';
...
export declare class Pokemon {
    ...
    updateSpeed(): void;
    calculateStat(statName: StatNameExceptHP, boost: number, modifier?: number): number;
    getStat(statName: StatNameExceptHP, unboosted?: boolean, unmodified?: boolean): number;
    ...
    maxMoveDisabled(move: Move): boolean;
    ...
    getSwitchRequestData(): AnyObject;
    ...
    clearItem(): boolean;
    setAbility(ability: string | Ability, source?: Pokemon | null, isFromFormeChange?: boolean): false | "" | (string & {
        __isID: true;
    });
    getAbility(): import("./dex-abilities").Ability;
    hasAbility(ability: string | string[]): boolean;
    clearAbility(): false | "" | (string & {
        __isID: true;
    });
    ...
    getVolatile(status: string | Effect): import("./dex-conditions").Condition | import("./dex-abilities").Ability | import("./dex-items").Item | import("./dex-moves").ActiveMove | import("./dex-species").Species | import("./dex-formats").Format | null;
