import { ActiveMove, AnyObject, Battle, CommonHandlers, Effect, Field, Item, Pokemon, Side, SparseBoostsTable } from './exported-global-types';
...
export declare type ModdedConditionData = ConditionData | Partial<ConditionData> & {
    inherit: true;
};
export declare class Condition extends BasicEffect implements Readonly<BasicEffect & ConditionData> {
