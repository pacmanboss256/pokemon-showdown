...
export declare class Side {
    ...
    getSlotCondition(target: Pokemon | number, status: string | Effect): import("./dex-conditions").Condition | import("./dex-abilities").Ability | import("./dex-items").Item | import("./dex-moves").ActiveMove | import("./dex-species").Species | import("./dex-formats").Format | null;
