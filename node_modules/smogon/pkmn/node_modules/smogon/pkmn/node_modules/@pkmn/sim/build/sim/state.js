...
exports.State = new class {
    serializeBattle(battle) {
        const state = /* Battle */ this.serialize(battle, BATTLE, battle);
    ...
    deserializeBattle(serialized) {
        const state = /* Battle */ typeof serialized === 'string' ? JSON.parse(serialized) : serialized;
        const options = {
    ...
    serializeSide(side) {
        const state = /* Side */ this.serialize(side, SIDE, side.battle);
    ...
    serializePokemon(pokemon) {
        const state = /* Pokemon */ this.serialize(pokemon, POKEMON, pokemon.battle);
    ...
    serializeChoice(choice, battle) {
        const state = /* Choice */ this.serialize(choice, CHOICE, battle);
    ...
    serializeActiveMove(move, battle) {
        ...
        const state = /* ActiveMove */ this.serialize(move, skip, battle);
