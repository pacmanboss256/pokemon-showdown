...
exports.Utils = new class {
    ...
    visualize(value, depth = 0) {
        ...
        const baseClass = ((value === null || value === void 0 ? void 0 : value.toString) && ((_a = /\[object (.*)\]/.exec(value.toString())) === null || _a === void 0 ? void 0 : _a[1])) || constructor;
        switch (baseClass) {
            case 'Map':
                if (depth > 2)
                    return `Map`;
                const mapped = [...value.entries()].map(val => `${this.visualize(val[0], depth + 1)} => ${this.visualize(val[1], depth + 1)}`);
    ...
    clearRequireCache(options = {}) {
        const excludes = (options === null || options === void 0 ? void 0 : options.exclude) || [];
    ...
    deepClone(obj) {
        ...
        if (Array.isArray(obj))
            return obj.map(prop => this.deepClone(prop));
