...
exports.Moves = {
    ...
    counter: {
        ...
        damageCallback(pokemon, target) {
            ...
            if (!lastAttackedBy || !lastAttackedBy.move || !lastAttackedBy.thisTurn)
                return false;
            // Hidden Power counts as physical
            if (this.getCategory(lastAttackedBy.move) === 'Physical' && ((_a = target.lastMove) === null || _a === void 0 ? void 0 : _a.id) !== 'sleeptalk') {
    ...
    encore: {
        ...
        condition: {
            ...
            onStart(target) {
                ...
                const lockedMove = ((_a = target.lastMove) === null || _a === void 0 ? void 0 : _a.id) || '';
    ...
    mirrorcoat: {
        ...
        damageCallback(pokemon, target) {
            ...
            if (!lastAttackedBy || !lastAttackedBy.move || !lastAttackedBy.thisTurn)
                return false;
            // Hidden Power counts as physical
            if (this.getCategory(lastAttackedBy.move) === 'Special' && ((_a = target.lastMove) === null || _a === void 0 ? void 0 : _a.id) !== 'sleeptalk') {
                return 2 * lastAttackedBy.damage;
            }
            return false;
        },
    ...
    mirrormove: {
        ...
        onHit(pokemon) {
            ...
            const lastMove = (target === null || target === void 0 ? void 0 : target.lastMove) && (target === null || target === void 0 ? void 0 : target.lastMove.id);
