...
exports.Formats = {
        ...
        onValidateTeam(team) {
            ...
            for (const set of team) {
                ...
                if (legends.includes(baseSpecies))
                    n++;
                if (n > 2)
                    return [`You can only use up to two restricted legendary Pok\u00E9mon.`];
            }
        },
    },
    standarddoubles: {
    ...
    twovstwo: {
        ...
        onStart() {
            if (this.format.gameType !== 'triples')
    ...
    nicknameclause: {
        ...
        onValidateTeam(team, format) {
            ...
            for (const set of team) {
                const name = set.name;
                if (name) {
                    if (name === this.dex.getSpecies(set.species).baseSpecies)
                        continue;
    ...
    batonpassclause: {
        ...
        onValidateSet(set, format, setHas) {
            ...
            for (const moveId of set.moves) {
                ...
                if (item.zMove && move.type === item.zMoveType && ((_a = move.zMove) === null || _a === void 0 ? void 0 : _a.boost)) {
