...
export declare class Pokemon {
    ...
    getVolatile(status: string | Effect): import("./dex-formats").Format | import("./dex-species").Species | import("./dex-items").Item | import("./dex-abilities").Ability | import("./dex-moves").ActiveMove | import("./dex-conditions").Condition | null;
