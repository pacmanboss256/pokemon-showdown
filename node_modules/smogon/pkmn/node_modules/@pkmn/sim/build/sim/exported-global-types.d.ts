...
export declare type StatNameExceptHP = 'atk' | 'def' | 'spa' | 'spd' | 'spe';
export declare type StatName = 'hp' | StatNameExceptHP;
...
export declare type BoostName = StatNameExceptHP | 'accuracy' | 'evasion';
...
export declare type GameType = 'singles' | 'doubles' | 'triples' | 'rotation' | 'multi' | 'free-for-all';
