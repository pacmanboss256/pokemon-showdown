...
export declare class TeamValidator {
    ...
    reconcileLearnset(species: Species, setSources: PokemonSources, problem: {
        type: string;
        moveName: string;
        [key: string]: any;
    } | null, name?: string): string[] | null;
    checkLearnset(move: Move, s: Species, setSources?: PokemonSources, set?: AnyObject): {
        type: string;
        [key: string]: any;
    } | null;
