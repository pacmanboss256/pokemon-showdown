...
class Field {
    ...
    setWeather(status, source = null, sourceEffect = null) {
        ...
        if (source) {
            ...
            if (!result) {
                if (result === false) {
                    if ((_a = sourceEffect) === null || _a === void 0 ? void 0 : _a.weather) {
    ...
    isWeather(weather) {
        ...
        if (!Array.isArray(weather)) {
            return ourWeather === dex_1.toID(weather);
        }
    ...
    isTerrain(terrain, target) {
        ...
        if (!Array.isArray(terrain)) {
            return ourTerrain === dex_1.toID(terrain);
        }
    ...
    addPseudoWeather(status, source = null, sourceEffect = null) {
        ...
        effectData = this.pseudoWeather[status.id] = {
            id: status.id,
            source,
            sourcePosition: source === null || source === void 0 ? void 0 : source.position,
            duration: status.duration,
        };
        if (status.durationCallback) {
            if (!source)
