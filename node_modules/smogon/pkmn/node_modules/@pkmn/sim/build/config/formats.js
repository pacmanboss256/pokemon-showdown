...
exports.Formats = [
    ...
    },
    {
        ...
        validateSet(set, teamHas) {
            ...
            if (!(species.name === 'Jolteon' && ability.name === 'Run Away')) {
                ...
                if (fakeValidation === null || fakeValidation === void 0 ? void 0 : fakeValidation.length)
    ...
    },
    {
        ...
        onModifySpecies(species, target, source, effect) {
            ...
            if (target && boosts[tier] > 20) {
                if (target.set.ability === 'drizzle')
                    tier = 'nubl';
                if (target.set.ability === 'drought')
                    tier = 'nubl';
                if (target.set.moves.includes('auroraveil'))
                    tier = 'nubl';
            }
    ...
    },
    {
        ...
        getSharedPower(pokemon) {
            ...
            for (const ally of pokemon.side.pokemon) {
                if (ally.previouslySwitchedIn > 0) {
                    if (['mirrorarmor', 'trace'].includes(ally.baseAbility))
                        continue;
        ...
        onBeforeSwitchIn(pokemon) {
            ...
            if (!format.getSharedPower)
                format = this.dex.getFormat('gen8sharedpower');
    ...
    },
    {
        ...
        onModifySpecies(species, target, source, effect) {
            ...
            return Object.assign(Object.assign({}, species), { types: types });
        },
        onSwitchIn(pokemon) {
    ...
    },
    {
        ...
        checkLearnset(move, species, lsetData, set) {
            ...
            if (!set.crossMovesLeft)
                return problem;
            // @ts-ignore
            if (this.checkLearnset(move, set.crossSpecies))
                return problem;
            // @ts-ignore
            set.crossMovesLeft--;
            return null;
        ...
        validateSet(set, teamHas) {
            ...
            if (Array.isArray(problems) && problems.length)
                return problems;
            if (!crossSpecies.exists || crossSpecies.isNonstandard)
                return this.validateSet(set, teamHas);
            const species = this.dex.getSpecies(set.species);
            const check = this.checkSpecies(set, species, species, {});
            if (check)
                return [check];
            if (!species.exists || species.isNonstandard || species === crossSpecies)
                return this.validateSet(set, teamHas);
            if (!species.nfe)
            ...
            const god = target.side.team.find(set => {
                ...
                if (set.item) {
                    ...
                    if (item.megaEvolves === set.species)
                        godSpecies = this.dex.getSpecies(item.megaStone);
                }
    ...
    },
    {
        ...
        validateSet(set, teamHas) {
            ...
            if (!teamHas.abilityMap) {
                ...
                for (const speciesid in Dex.data.Pokedex) {
                    ...
                    if (pokemon.requiredAbility || pokemon.requiredItem || pokemon.requiredMove)
                        continue;
                    if (this.ruleTable.isRestrictedSpecies(pokemon))
                        continue;
            ...
            if (!pokemonWithAbility)
                return [`${this.dex.getAbility(set.ability).name} is not available on a legal Pok\u00e9mon.`];
            // @ts-ignore
            ...
            for (const donor of pokemonWithAbility) {
                ...
                if (!format.getEvoFamily)
                    format = this.dex.getFormat('gen8inheritance');
        ...
        onValidateTeam(team, f, teamHas) {
            ...
            for (const set of team) {
                const abilitySources = (_a = teamHas.abilitySources) === null || _a === void 0 ? void 0 : _a[this.dex.toID(set.species)];
                if (!abilitySources)
                    continue;
                let format = this.format;
                if (!format.getEvoFamily)
    ...
    },
    {
        ...
        onSwitchIn(pokemon) {
            ...
            if (status === null || status === void 0 ? void 0 : status.exists) {
