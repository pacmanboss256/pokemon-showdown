...
exports.Sets = new class {
    ...
    packSet(s) {
        ...
        const getIV = (stat) => s.ivs[stat] === 31 || s.ivs[stat] === undefined ? '' : s.ivs[stat].toString();
        // ivs
        let ivs = '|';
        if (s.ivs) {
            ivs = '|' +
    ...
    exportSet(s, data) {
        ...
        species = (_b = (_a = data === null || data === void 0 ? void 0 : data.getSpecies(species || name)) === null || _a === void 0 ? void 0 : _a.name) !== null && _b !== void 0 ? _b : species;
        ...
        if (s.item) {
            const item = (_d = (_c = data === null || data === void 0 ? void 0 : data.getItem(s.item)) === null || _c === void 0 ? void 0 : _c.name) !== null && _d !== void 0 ? _d : s.item;
            buf += ' @ ' + item;
        }
        buf += '  \n';
        if (s.ability && (!data || (data === null || data === void 0 ? void 0 : data.gen) >= 3)) {
            const ability = (_f = (_e = data === null || data === void 0 ? void 0 : data.getAbility(s.ability)) === null || _e === void 0 ? void 0 : _e.name) !== null && _f !== void 0 ? _f : s.ability;
            buf += 'Ability: ' + ability + '  \n';
        }
        if (s.level && s.level !== 100) {
            buf += 'Level: ' + s.level + '  \n';
        ...
        if (s.moves) {
            for (let move of s.moves) {
                if (move) {
                    move = (_h = (_g = data === null || data === void 0 ? void 0 : data.getMove(move)) === null || _g === void 0 ? void 0 : _g.name) !== null && _h !== void 0 ? _h : move;
                    buf += '- ' + exportMove(move) + '  \n';
                }
            }
        }
    ...
    for (; i < lines.length; i++) {
        ...
        if (line === '' || line === '---' || line.substr(0, 3) === '===' ||
            ...
            if (line.substr(line.length - 1) === ')' && parenIndex !== -1) {
                ...
                s.species = (_b = (_a = data === null || data === void 0 ? void 0 : data.getSpecies(sub)) === null || _a === void 0 ? void 0 : _a.name) !== null && _b !== void 0 ? _b : sub;
                line = line.substr(0, parenIndex);
                s.name = line;
            }
            else {
                s.species = (_d = (_c = data === null || data === void 0 ? void 0 : data.getSpecies(line)) === null || _c === void 0 ? void 0 : _c.name) !== null && _d !== void 0 ? _d : line;
                s.name = '';
            }
        }
